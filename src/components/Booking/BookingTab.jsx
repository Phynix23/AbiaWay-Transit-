...
import ABSINPaymentDemo from '../Payment/ABSINPaymentDemo';  // ✅ CORRECT IMPORT
...
const BookingTab = () => {
  ...
  const handlePayment = () => {
    ...
    if (bookingDetails.paymentMethod === 'absin') {
      ...
      setRideDetails({
        ...
        busId: bookingDetails.route?.id || 'AB-101',
  ...
  const handleABSINSuccess = (result) => {
    // Create booking after successful ABSIN payment
    createBooking({
      ...bookingDetails,
      fare: paymentAmount,
      status: 'confirmed',
